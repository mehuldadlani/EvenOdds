...
@GenerateMocks([], customMocks: [
  ...
  MockSpec<BettingContractService>(onMissingStub: OnMissingStub.returnDefault),
// @stacked-mock-spec
])
void registerServices() {
  ...
  getAndRegisterContractServiceService();
...
MockContractServiceService getAndRegisterContractServiceService() {
  _removeRegistrationIfExists<BettingContractService>();
  final service = MockContractServiceService();
  locator.registerSingleton<BettingContractService>(service);
  return service;
}
// @stacked-mock-create
